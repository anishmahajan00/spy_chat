...
print 'Hello!'
print"what's going on dude"
print'Let\'s Start Our App buddy'
...
def add_status():
    ...
    if spy.current_status_message != None:
        print "whats your current status message " + spy.current_status_message + "\n"
    else:
        print 'You should have something in your status \n'
